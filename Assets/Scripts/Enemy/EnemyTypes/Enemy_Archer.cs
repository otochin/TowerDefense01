    ...
    private void Attack(IDamageable target)
    {
        ...
        if (arrowPrefab != null && shootPoint != null)
        {
            ...
            if (projectile != null)
            {
                ...
                {
                    projectile.Initialize(targetMono.transform, enemyBase.AttackPower, 10f);
                }
                else
                {
                    projectile.Initialize(targetPosition, enemyBase.AttackPower, 10f);
                }
            }
        }
        else
